{!! Form::open(array('url' => 'newAppPhone', 'class' => 'uk-form')) !!}
	...
	{{ Form::select('country_code', [null=>'Please Select'] + Country::countryCodesArray(), null, ['class' => 'uk-select uk-background-muted selectField', 'required' => 'required']) }}
	
	{{ Form::label('number', 'Phone Number', ['class' => 'uk-form-label']) }}
	{!! Form::text('number', null, array('class' => 'uk-input  uk-margin-small-top uk-margin-small-bottom', 'placeholder' => '981276345', 'required' => 'required')) !!}
